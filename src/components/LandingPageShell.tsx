...
export default function LandingPageShell({ children }: { children: ReactNode }) {
  return (
      ...
      >
        <div className="container py-3">
          <a
            ...
            className="inline-flex w-full items-center justify-center rounded-md bg-gold px-4 py-2.5 text-sm font-semibold text-section-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          >
