...
const allServices = [
  ...
  { title: "Building Maintenance Contracts", desc: "Reliable 24/7 building maintenance to keep your property safe, functional and well-presented. We handle repairs, inspections and preventative upkeep.", image: "/images/service-maintenance.png" },
  { title: "Full Refurbishment & Restoration", desc: "Complete property transformations and restorations from planning through to flawless completion. We handle every aspect — structural work, plastering, flooring, electrics, plumbing and decorating.", image: "/images/service-refurbishment-new.png" },
  { title: "Extensions & New Builds", desc: "Expertly designed and built extensions and new builds managed from foundations to final finishes. Expert craftsmanship and meticulous attention to detail.", image: "/images/service-extensions.png" },
  ...
  { title: "Roofing", desc: "Expert roofing services from repairs to complete installations. Durable, weather-resistant solutions built to protect your property for years to come.", image: "/images/service-roofing.png" },
  { title: "EWI & Render", desc: "Specialist External Wall Insulation with high-performance silicone render systems. Improving energy efficiency while delivering a durable, modern finish.", image: "/images/service-render-new.png" },
